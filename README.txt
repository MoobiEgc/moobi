...
This document describes how to copy and customise the Moobi (bootstrapbase) theme so that
...
From your Moodle theme directory right click on moobi and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of moobi.
...
underscores. For the purpose of this tutorial we will call the theme 'moobitheme'.

On opening 'moobitheme' your you will find several files and sub-directories which have
files within them.
...
/lang/en/theme_moobi.php
/lang/pt_br/theme_moobi.php
...
where the old theme name occurs, in this case moobi. So using the above list as
a guide, search through and change all the instances of the theme name
'moobi' to 'moobitheme'. This includes the filename of the lang/en/theme_moobi.php.
You need to change this to 'theme_moobitheme.php'.
...
and then click on (Moobitheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the Moobi theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > Moobi
